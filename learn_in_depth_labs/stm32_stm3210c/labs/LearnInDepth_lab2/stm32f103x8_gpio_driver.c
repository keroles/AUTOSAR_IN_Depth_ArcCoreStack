 ...
 */
void MCAL_GPIO_Init  (GPIO_TypeDef_MCAL *GPIOx , GPIO_PinConfig_t* PinConfig)
{
 ...
 * Note					-none
 */
void MCAL_GPIO_DeInit    (GPIO_TypeDef_MCAL *GPIOx )
{
	/*
 ...
 * Note					-none
 */
uint8_t  MCAL_GPIO_ReadPin		(GPIO_TypeDef_MCAL*  GPIOx , uint16_t PinNumber)
{
	uint8_t bitstatus ;
 ...
 * Note					-none
 */
uint16_t MCAL_GPIO_ReadPort		(GPIO_TypeDef_MCAL *GPIOx)
{
	uint16_t port_value ;
 ...
 * Note					-none
 */
void MCAL_GPIO_WritePort (GPIO_TypeDef_MCAL *GPIOx , uint16_t Value)
{
 ...
 * Note				-none
 */
void MCAL_GPIO_WritePin	(GPIO_TypeDef_MCAL *GPIOx , uint16_t PinNumber, uint8_t Value)
{
 ...
 * Note				-none
 */
void MCAL_GPIO_TogglePin (GPIO_TypeDef_MCAL *GPIOx , uint16_t PinNumber)
{
	GPIOx->ODR ^= (PinNumber);
}
 ...
 * Note				-none
 */
uint8_t MCAL_GPIO_LockPin	(GPIO_TypeDef_MCAL *GPIOx , uint16_t PinNumber)
{
