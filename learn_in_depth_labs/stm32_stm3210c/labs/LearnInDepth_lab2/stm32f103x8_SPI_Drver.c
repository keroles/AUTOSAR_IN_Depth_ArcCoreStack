 ...
 */
void MCAL_SPI_Init (SPI_TypeDef_MCAL *SPIx, SPI_Config* SPI_Config)
{
...
void MCAL_SPI_DeInit (SPI_TypeDef_MCAL *SPIx)
{
	if (SPIx == SPI1)
	{
...
void  MCAL_SPI_TX_RX (SPI_TypeDef_MCAL *SPIx, uint16_t *pTxBuffer,enum PollingMechism PollingEn )
{
...
void MCAL_SPI_SendData	(SPI_TypeDef_MCAL *SPIx, uint16_t *pTxBuffer,enum PollingMechism PollingEn )
{
	uint8_t index = 0 ;
	if (SPIx == SPI1)
	{
...
void MCAL_SPI_ReceiveData	(SPI_TypeDef_MCAL *SPIx, uint16_t *pTxBuffer ,enum PollingMechism PollingEn )
{
	uint8_t index = 0 ;
	if (SPIx == SPI1)
	{
...
void MCAL_SPI_GPIO_Set_Pins (SPI_TypeDef_MCAL *SPIx)
{
