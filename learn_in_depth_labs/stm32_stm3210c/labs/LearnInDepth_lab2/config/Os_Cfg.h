...
// Counter Id's
#define COUNTER_ID_OsCounter1	0
...
//DON'T EFFECT AS BASED ON CLOCK TREE ANS SYSTICK CONFIGURATION THE TICK TIME = 2MS
#define OSTICKDURATION			2000000UL    // Time between ticks in nano seconds
...
#define TASK_ID_LearnIndepth_exTask	2
#define TASK_ID_bTask	1
