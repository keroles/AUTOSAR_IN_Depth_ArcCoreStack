...
void MCAL_UART_Init (USART_TypeDef_MCAL *USARTx, UART_Config* UART_Config);
void MCAL_UART_DeInit (USART_TypeDef_MCAL *USARTx);


void MCAL_UART_GPIO_Set_Pins (USART_TypeDef_MCAL *USARTx);


void MCAL_UART_SendData	(USART_TypeDef_MCAL *USARTx, uint16_t *pTxBuffer,enum Polling_mechism PollingEn );
void MCAL_UART_ReceiveData	(USART_TypeDef_MCAL *USARTx, uint16_t *pTxBuffer ,enum Polling_mechism PollingEn );

void MCAL_UART_WAIT_TC (USART_TypeDef_MCAL *USARTx ) ;
